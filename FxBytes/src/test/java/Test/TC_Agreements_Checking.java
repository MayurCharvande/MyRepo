...
import POM.Agreements_Checking_Program;
import POM.Login;
import Pojo.Browser;
import Utility.BaseTest;
import Utility.Scrolling_Upto_Bottom;
import Utility.Scrolling_Upto_Element;

public class TC_Agreements_Checking extends BaseTest
{
@BeforeSuite
...
@Test(priority=1)
	public void loginFunctionality() throws EncryptedDocumentException, IOException, InterruptedException 
	{
...
@Test(priority=2)
	...
	{
	Scrolling_Upto_Bottom obj3 = new Scrolling_Upto_Bottom();
	Agreements_Checking_Program obj2 = new Agreements_Checking_Program(driver);
